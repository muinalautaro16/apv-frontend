...
const Formulario = () => {
  ...
  return (
        ...
        >
            ...
            <input 
                type="submit" 
                className="bg-indigo-600 rounded-md text-white w-full p-3 font-bold uppercase hover:bg-indigo-700 cursor-pointer transition-colors"
