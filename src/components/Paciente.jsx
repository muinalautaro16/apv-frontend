...
const Paciente = ({paciente}) => {
  ...
  const { email, fecha, nombre, propietario, sintomas, _id, telefono } = paciente;
  ...
  return (
      <>
        <div className="mx-5 bg-white shadow-md px-5 py-10 rounded-xl mt-8">
            ...
            <p className="font-bold uppercase text-gray-500 my-2">Email: {''}
                <span className="font-normal normal-case text-black">{email}</span>
            </p>

            <p className="font-bold uppercase text-gray-500 my-2">Telefono: {''}
